...
public class ComptadorDosDigitsTest {
    public static void main(String[] args) {
        ...
        do {
            ...
            if (comptador.getDigit() == 20) {
                comptador.setDigit(0);
            }
        }while(option != 0);
    }
    public static void runGUI(){
        System.out.println("1. Posar pt_1.comptador a 0");
        System.out.println("2. Incrementar el valor");
        System.out.println("3. Consultar valor del pt_1.comptador");
